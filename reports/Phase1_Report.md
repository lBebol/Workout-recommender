...
The data collection process involves web scraping techniques to extract exercise information from MuscleWiki. The scraping methodology follows these steps:

1. **Page Identification**: Identify target pages for each muscle group (chest, back, shoulders, arms, legs, core)
2. **Element Selection**: Use CSS selectors to identify exercise name, difficulty, equipment, and category elements
3. **Data Extraction**: Parse and extract structured data from HTML content
...
Multiple machine learning models will be applied and compared:
...
4. Machine Intelligence Course Guidelines, Faculty of Engineering, Cairo University
